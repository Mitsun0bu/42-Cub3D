...
/*   Updated: 2022/06/14 10:03:01 by llethuil         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
void	init_images(t_data *data, t_config *config)
{
	...
	// data->south_texture.tex = mlx_xpm_file_to_image(data->win.mlx, config->we_texture_path, &data->south_texture.wdth, &data->south_texture.hgt);
